...
$myusername=$_POST['username']; 
		...
		$sql="SELECT * FROM parent WHERE parent_name='$myusername' and password='$mypassword' ";
		...
		// Register $myusername, $mypassword and redirect to file "login_success.php"
			if($status==1)
			{
					...
					$_SESSION['ses']=$ses;
			          		...
			          		{
			                	header("Location:parent/firstpasschange.php");
			                }
			            	else 
			            	{
			                	header("Location:parent/welcome.php");
