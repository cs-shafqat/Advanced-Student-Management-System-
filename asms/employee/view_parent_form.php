...
<form onsubmit="return addparent()" class="form-horizontal form-label-left input_mask" method="post" action="update_parent_process.php?id=2" enctype="multipart/form-data" >
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                <input type="text" class="form-control has-feedback-left" name="pfirst_name" value="<?php echo $row['first_name']; ?>" required="required" placeholder="First Name"maxlength="30" onblur="return onblurFname(this,1);" onkeypress="return checkFname(event,this);"  >
                <span class="fa fa-user form-control-feedback left" aria-hidden="true"><span style='color:red;'>*</span></span>
              </div>

              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                <input type="text" class="form-control"  name="plast_name" value="<?php echo $row['last_name']; ?>" required="required" placeholder="Last Name"  maxlength="30" onblur="return onblurLname(this,1);" onkeypress="return checkLname(event,this);">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input class="date-picker form-control col-md-7 col-xs-12"  value="<?php echo $row['dob']; ?>" name="pdob" required="required" type="date"id="dob" onblur="return onblurdob(this);" onchange="return onblurdob(this);">
                </div>
              </div>
              <div class="form-group">
                  <div class="col-md-3 col-sm-3 col-xs-12 " >
