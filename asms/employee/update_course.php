                      ...
                      <table id="datatable-buttons" class="table table-striped jambo_table ">
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class=" "> <a href="edit_course.php ?id=<?php echo $n?> "><i class="fa fa-edit fa-fw"></i></a> ||   <a href="delete_process.php"  onclick="return confirm('Are you sure You Want To Delete it?');" id="show-option" title="Delete"> <i class="fa fa-eraser fa-fw" onclick=""></i></a></td>
                          </tr>
                          <?php
                              }
                            }  else {
