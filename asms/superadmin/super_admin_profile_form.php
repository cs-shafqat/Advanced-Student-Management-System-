...
<?php
  ...
  if(isset($_GET['id']))
   $id= $_GET['id'];
 $sql="SELECT * FROM super_admin where user_name='$id' limit 1";
...
$row=mysql_fetch_array($result);
  ...
  ?>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="form" onsubmit="return handleinput()" class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="update_profile.php ?id=1 ">
