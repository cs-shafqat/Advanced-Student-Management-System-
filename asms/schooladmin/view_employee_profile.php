   ...
   <div class="col-md-8 col-md-offset-2">
    <div class="x_panel ">
     ...
     $sql="SELECT * FROM employee WHERE employee_name='$id' AND school_reg='$reg' ";
            ...
            <form  onsubmit="return addemployee()" class="form-horizontal form-label-left input_mask" method="post" enctype="multipart/form-data" action="update_employee_profile.php" >
