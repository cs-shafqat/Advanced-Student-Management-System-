...
if(isset($_POST['submit']))	
{
	...
	$sql5="SELECT * FROM fee WHERE class_name='$class' AND school_reg='$reg' AND session='$ses' ";
	$result5=mysql_query($sql5);
	$row5=mysql_fetch_array($result5);
	$fee=$row5['fee'];
	$sql6="INSERT INTO fee_details(student_id, class_tital, fee, school_reg, session)VALUES('$user_name', '$class', '$fee', '$reg', '$ses')";
