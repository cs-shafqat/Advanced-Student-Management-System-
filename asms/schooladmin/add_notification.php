                ...
                <div class="form-group">
                  ...
                  <div class="ln_solid"></div>
                    ...
                    <div class="form-group ">
                      ...
                      <a href="add_notification.php">  <button type="button" class="btn btn-defalt col-md-3 col-sm-3 col-xs-12" name="cencel" style="width:120px">Cancel</button></a>
                     
                        <button type="submit" class="btn btn-success col-md-3 col-sm-3 col-xs-12" name="submit" style="width:120px">Send</button>
