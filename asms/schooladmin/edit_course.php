...
require("../require/connection.php");
 ...
 if(isset($_GET['id']))
 { $n=$_GET['id'];
 $sql="SELECT * FROM subject WHERE subject_code='$n' AND school_reg='$reg'";
              ...
              <div class="x_panel">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" value="<?php echo $row['subject_tital'];?>"  class="form-control alphaNumHyph" name="title" id="title"  required="required" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" class="form-control" readonly="true"  value="<?php echo $row['subject_code'];?>" name="code" id="code"  required="required" >
                    </div>
                  </div>
                  ...
                  <div class="ln_solid"></div>
                   <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-4">
                    <div class="form-group ">
                        ...
                        <button type="submit" class="btn btn-success col-md-6 col-md-offset-6 col-sm-3 col-xs-12" name="sbmit" style="width:120px">Update</button>
