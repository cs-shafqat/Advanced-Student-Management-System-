        ...
        <div class="clearfix"></div>
            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                <input type="text" class="form-control has-feedback-left" value="<?php echo $row['first_name']; ?>" name="first_name" required="required" placeholder="First Name" maxlength="30" onblur="return onblurFname(this,1);" onkeypress="return checkFname(event,this);" >
              ...
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input type="text" class="form-control" name="cnic" value="<?php echo $row['cnic']; ?>"  data-inputmask="'mask' : '99999-9999999-9'" onkeyup="return cnicCheck(this,1);">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input class="date-picker form-control col-md-7 col-xs-12" value="<?php echo $row['dob']; ?>" id="dob" name="dob" required="required" type="date" >
                </div>
              </div>
              <div class="form-group">
