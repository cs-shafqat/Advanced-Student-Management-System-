...
include("up.php");
  ...
  ?>
  <title>Class Subject Record</title>
  <div class="col-md-12 ">
                      ...
                      <table id="datatable-buttons" class="table table-striped jambo_table ">
                        ...
                        <tbody>
                          <tr class="even pointer">
                            ...
                            <td class=" "> <a href="edit_subject_teacher.php ?id=<?php echo $f  ?>& id1=<?php echo $u ?> "><i class="fa fa-edit fa-fw"></i></a> ||   <a href="class_subject_delete_process.php ?id=<?php echo $u?> &id1=<?php echo $f?> "  onclick="return confirm('Are you sure You Want To Delete it?');" id="show-option" title="Delete"> <i class="fa fa-eraser fa-fw" onclick=""></i></a></td>
                          </tr>
                          <?php
