...
include("up.php");
  ...
  <div class="col-md-12 ">
           ...
           <div class="x_panel">
                  <div class="x_title">
                    <h2 style="align:center;">View Fine</h2>
                                        <div class="clearfix"></div>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table id="datatable-buttons" class="table table-striped jambo_table ">
                        <thead>
                          ...
                          <tr class="headings">
                            <th class="column-title" style="width:20%">Fine Title</th>
                            <th class="column-title" style="width:40%">Discription</th>
                        ...
                        <tbody>
                          <tr class="even pointer">
                            <?php
                                  ...
                                  $sql = "SELECT * FROM fine WHERE school_reg = '$reg' AND session='$ses'";
                                  $result=mysql_query($sql);
                                 
                                  if (mysql_num_rows($result) > 0) {
                                  // output data of each row
                                  while($row= mysql_fetch_array( $result) ) {
                                  $title=$row['fine_tital'];
                                  $dis=$row['fine_discription'];
                                  $fee=$row['amount'];
