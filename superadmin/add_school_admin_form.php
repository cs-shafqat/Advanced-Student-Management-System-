...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form id="form" onsubmit="return handleinput()" class="form-horizontal form-label-left input_mask" method="post" action="add_school_admin_process.php?id=1" enctype="multipart/form-data">
               <div class="form-group">
                  <div class="col-md-3 col-sm-3 col-xs-12 col-md-offset-8">
                  <img id="myImg" height="150px" width="150px" src="../gent/production/images/user.png" alt="your image" /><span style='color:red;'>*</span>
                  <input type='file' name="user_pic" required="true" id="upload" onchange="return checkSize()" />
                  </div>
                </div>
                <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                <input type="text" class="form-control" maxlength="30" id="last_name" name="last_name" dragable="false" autocomplete="off" required="required" placeholder="Last Name"onblur="return onblurLname(this,1);" onkeypress="return checkLname(event,this);">
              ...
              <div class="form-group ">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12  ">
                  <input type="text" class="form-control" name="user_name" id="user_name" maxlength="20" dragable="false" autocomplete="off" required="required" placeholder="User Name" onblur="return onblurUsername1(this,1);" onkeypress="return checkUsername(event,this);" >
                </div>
              </div>
              <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 " >
