             ...
             <div class="row">
                ...
                <div class="col-md-4" style="text-align: center;">
                  ...
                  <h4 >
                        ...
                        Subject  : <?php echo $subject_id; ?> <br>
                        ...
                        <table id="datatable-buttons" class="table table-striped jambo_table table-bordered">
                          <thead>
                            ...
                            <tbody>
                              ...
                              <?php
                                 $sql1="SELECT * FROM test_details WHERE class_name='$class' AND subject_id='$subject_id' AND school_reg = '$reg' AND session='$ses' AND student_id='$student_id'";
