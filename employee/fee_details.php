...
?>  
  ...
  <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-2">
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                <form class="form-horizontal form-label-left input_mask" method="post" action="fee_details_process.php" >
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <?php
                                  ...
                                  while($row2 = mysql_fetch_array( $result2 ))
                                   {
                                    $t=$row2['title'];
                                    $sql1="SELECT * FROM fee WHERE class_name='$t'  AND school_reg= '$reg' AND session='$ses' ";
